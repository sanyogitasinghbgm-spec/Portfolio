...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "sanyogitasinghbgm@gmail.com",
    href: "mailto:sanyogitasinghbgm@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <a
                      ...
                      className="p-3 rounded-xl glass hover:bg-primary/10 hover:text-primary transition-all duration-300 flex items-center justify-center w-11 h-11"
                    >
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                Whether it's an internship, an entry-level role, or an exciting
                collaboration, I'm always eager to learn, build, and contribute
                to meaningful software projects. Let's connect!
              </p>
            </div>
          </div>
        </div>
